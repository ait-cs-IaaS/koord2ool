...
1. Ensure any install or build dependencies are removed before the end of the layer when doing a
   build.
2. Update the README.md and CHANGELOG.md with details of changes to the interface, such as
...
reported by contacting the [project team](https://github.com/ait-cs-IaaS). All
